...
<!--nav-->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Leave Form</div>
  ...
  <input class="form-control" name="name" id="cshort" required="required"  onblur="courseAvailability()">       
		...
		<div class="col-lg-6">
		<input class="form-control" name="email" id="cfull" required="required"  onblur="coursefullAvail()">         
	<span id="course-status" style="font-size:12px;"></span>				</div>
	 </div>	
										
	 <br><br>
	 <label for="msg">Reason for leave</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;


						<textarea placeholder="Message" name="message" required=""></textarea><br><br><b>		Please also insert your email inside the box above		</b>				
		...
		<br><br>		
							...
							<input type="submit" class="btn btn-primary" name="submit" value="submit"></button><br>
