<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">Professor Support System</a>
			</div>
                ...
                <div class="sidebar-nav navbar-collapse">
                 ...
                 <li>
                  ...
                  <li>
                            <a href="lab.php"><i class="fa fa-bar-chart-o fa-fw"></i>Lab Performance<span class="fa arrow"></span></a>
                            

                  </li>

                   <li>
                            <a href="class_performance.php"><i class="fa fa-bar-chart-o fa-fw"></i>Class Performance<span class="fa arrow"></span></a>
                   ...
                   <li>
                            <a href="s.php"><i class="fa fa-bar-chart-o fa-fw"></i>Leave Form<span class="fa arrow"></span></a>
                  </li>
                   <li>
